  ...
  const cards = [
    {
      title: "DHT11",
      img: ImgDHT11,
      text: `Sensor de temperatura e umidade
...
Baixo consumo de energia`
    },
    {
      title: "ESP32",
      img: ImgESP32,
      text: `Processador dual-core Tensilica Xtensa LX6
...
Baixo consumo de energia`
    },
    {
      title: "MQ-135",
      img: ImgMQ135,
      text: `Detecta: NH₃, NOₓ, álcool, benzeno, fumaça, CO₂
...
Ideal para monitoramento da qualidade do ar`
    },
    {
      title: "LEDs",
      img: ImgLED,
      text: `LED Verde: funcionamento normal
